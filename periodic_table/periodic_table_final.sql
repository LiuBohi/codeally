...
INSERT INTO public.types VALUES (17, 'metalloid');
INSERT INTO public.types VALUES (18, 'nonmetal');
...
SELECT pg_catalog.setval('public.types_type_id_seq', 18, true);
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_atomic_number_fkey6 FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_atomic_number_fkey7 FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;
